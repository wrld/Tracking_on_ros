...
int main(int argc, char** argv)
{
  ...
  if(!nh.getParam("video_name",video_name))video_name = "/home/gjx/视频/VID_20191222_154610.mp4";
 ...
 // waitKey( 10000 );
  ...
  if(choose_flag){
   ...
   // cout << "正在读取第" << currentFrame << "帧" << endl;
    waitKey( 10 );
    image = frame.clone();
    resize(image,image,Size(img_width*0.7,img_height*0.7),0,0,INTER_LINEAR);
